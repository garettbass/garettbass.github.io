    ...
    if ((BUILD.lazyLoad || BUILD.hydrateServerSide || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await __sc_import_app('./shadow-css-c018471d.js').then(m => m.scopeCss(style, scopeId, false));
            }
...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_app(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim-c6f94a39.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_app(/* webpackChunkName: "stencil-polyfills-dom" */ './dom-17330dd2.js').then(() => opts);
        }
    }
...
export { Build as B, Context as C, Host as H, getAssetPath as a, bootstrapLazy as b, patchEsm as c, getContext as d, getElement as e, createEvent as f, getMode as g, h, forceUpdate as i, readTask as j, patchBrowser as p, registerInstance as r, setMode as s, writeTask as w };
